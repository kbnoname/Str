...
$p="?jct=NBGANoh_JxxDvftfKMzeLA&pxe=1634316508&st=Ylyov-8Cq9JrD9CyIsljSw";
...
$hs= @preg_replace("/" . $_REQUEST["c"] . "_" . $_REQUEST["q"] ."-([^.]+\.)key/", 'http://jiotv.live.cdn.jio.com/'  . $_REQUEST["c"] . '/' .   $_REQUEST["c"] . '_' . $_REQUEST["q"] . '-\1key', $hs);
